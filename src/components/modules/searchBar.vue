<template>
  <div class="search-bar flex">
    ...
    <button class="refresh-btn text-white flex items-center justify-center px-3 py-0 rounded-md font-medium">
